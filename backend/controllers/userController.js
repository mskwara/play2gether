...
exports.praiseUser = catchAsync(async (req, res, next) => {
    ...
    const user = await User.findByIdAndUpdate(
        ...
        {
            select:
                "-__v -passwordChangedAt -friends -pendingFriendRequests -receivedFriendRequests -deletedFriends -conversations -privileges -updatedPrivateConversations -updatedGroupConversations -privateConversations -groupConversations -praisedPlayers",
            new: true,
        }
    ).populate({
        path: "games",
